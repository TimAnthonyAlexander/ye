...
import { Box, Typography, Button, Container, Stack, Chip, Link as MuiLink } from "@mui/material";
import {
    Terminal,
    Layers,
    Search,
...
export default function Landing() {
    ...
    return (
        <Box sx={{ minHeight: "100vh" }}>
            ...
            >
                <Box component="img" src="/img/ye-logo-light.svg" alt="Ye" sx={{ height: 32 }} />
            ...
            <Container maxWidth="lg">
                <Box sx={{ pt: 12, pb: 8, textAlign: "center" }}>
                    ...
                    >
                        Subagents, planning, web search, skills, hooks — Ye lives in your terminal
                ...
                <Box sx={{ py: 10 }}>
                    ...
                    >
                        Open source from day one. Built on the same agent-loop architecture as the
                        closed tools — but you can read the source, extend it, and run it on
                ...
                <Box sx={{ py: 10 }}>
                    ...
                    >
                        <Box sx={{ flex: 1 }}>
                            ...
                            <Typography
                                sx={{ fontSize: "0.938rem", color: "#666", lineHeight: 1.6 }}
                            >
